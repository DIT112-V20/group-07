...
### Smartcar
To set-up the car, please see the documentation provided by [@platisd](https://github.com/platisd)  https://platis.solutions/blog/2020/02/16/smartcar-gets-an-esp32-upgrade/ and https://github.com/platisd/smartcar_shield
#### Sensors
